...
var dialogue = [
	"Welcome to the island! (Press E to continue)"
	,"Your life depends on your speed and accuracy.. or ELSE!"
	,"Shoot the targets and defeat the drone before you run out of time!"
